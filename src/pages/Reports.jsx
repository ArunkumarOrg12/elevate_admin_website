          ...
          <Card key={r.id} className="p-5 hover-lift flex flex-col">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Badge variant={r.format === 'PDF' ? 'pdf' : 'excel'}>{r.format}</Badge>
                  <span className="text-xs text-gray-400">{r.pages} pages</span>
                  <Badge variant={r.status === 'Ready' ? 'completed' : 'scheduled'}>{r.status}</Badge>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
              ...
              <div className="flex gap-2">
                <Button variant="secondary" size="sm" className="text-xs py-1 px-2 h-auto">
                  <Eye size={12} /> Preview
                </Button>
